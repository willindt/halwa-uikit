...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement("img", { src: "/images/egg/logo.png", width: "40px" }));
...
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout, buy = _a.buy;
...
var StyledNavTitle = styled__default['default'].div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-size: 1.2rem;\n  font-weight 600;\n  color: #FFFFFF;\n  margin-left: 24px;\n  margin-right: 12px;\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-size: 1.2rem;\n  font-weight 600;\n  color: #FFFFFF;\n  margin-left: 24px;\n  margin-right: 12px;\n"])));
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, buy = _a.buy; _a.toggleTheme; _a.langs; _a.setLang; _a.currentLang; _a.cakePriceUsd; var links = _a.links; _a.priceLink; var profile = _a.profile, children = _a.children;
        ...
        React__default['default'].createElement(StyledNav, null,
            React__default['default'].createElement(StyledNavLeft, { showMenu: showMenu },
                ...
                React__default['default'].createElement(StyledLinkContainer, null,
                    React__default['default'].createElement(StyledNavTitle, { as: "a", href: "#/swap" }, "$GHOSTFACE"),
                    React__default['default'].createElement(StyledNavLink, { as: "a", href: "https://charts.bogged.finance/?token=0x0952ddffde60786497c7ced1f49b4a14cf527f76" }, "Chart"))),
            React__default['default'].createElement(StyledNavRight, null,
                React__default['default'].createElement(Flex, null,
                    React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, buy: buy }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#10161C", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#10161C", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#1E262F", gradients: {
